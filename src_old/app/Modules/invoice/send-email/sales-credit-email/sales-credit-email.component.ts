...
@Component({
  selector: 'app-sales-credit-email',
  templateUrl: './sales-credit-email.component.html',
  styleUrls: ['./sales-credit-email.component.css']
})
export class SalesCreditEmailComponent {
