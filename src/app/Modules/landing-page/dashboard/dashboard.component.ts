...
export class DashboardComponent {
    ...
    getSalesCreditNote(items: any[], searchText: string): any[] {
        if (!items || !searchText) {
            return items;
        }
        searchText = searchText.toLowerCase();
    ...
    get SalesCreditNote() {
        return this.getSalesCreditNote(this.invoiceStatuslistData, this.publicVariable.searchText);

    }


    invoiceGetFilteredList(items: any[], searchText: string): any[] {
    ...
    get invoicefilteredList() {
        return this.invoiceGetFilteredList(this.invoiceStatuslistData, this.publicVariable.searchText);
